...
const router_permission = express.Router();
...
router_permission.post('/', passport.authenticate('jwt', {
    session: false
}), function (req, res) {
...
router_permission.get('/', passport.authenticate('jwt', {
    session: false
}), function (req, res) {
...
// Update a permission
router_permission.put('/:id', passport.authenticate('jwt', {
    session: false
}), function (req, res) {
...
// Delete a permission
router_permission.delete('/:id', passport.authenticate('jwt', {
    session: false
}), function (req, res) {
...
module.exports = router_permission;